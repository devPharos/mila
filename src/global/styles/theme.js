...
export default {
  ...
  icons: {
    Sick: (
      <MaterialIcons
        name="sick"
        style={{ color: "rgb(28,237,112)", fontSize: 22 }}
      />
    ),
    Absent: (
      <FontAwesome
        style={{ color: "rgb(237,28,36)", fontSize: 22 }}
        name="times"
      />
    ),
    Present: (
      <FontAwesome
        style={{ color: "rgb(42,39,115)", fontSize: 22 }}
        name="check"
      />
    ),
    Transfer: (
      <FontAwesome
        style={{ color: "rgb(237,164,28)", fontSize: 22 }}
        name="exchange"
      />
    ),
    Vacation: (
      <FontAwesome
        style={{ color: "rgb(139,28,237)", fontSize: 22 }}
        name="plane"
      />
    ),
    Halfpresent: (
      <FontAwesome
        style={{ color: "rgb(237,139,28)", fontSize: 22 }}
        name="check"
      />
    ),
  },
