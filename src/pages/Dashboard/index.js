...
export function Dashboard({ navigation }) {
  ...
  useEffect(() => {
    ...
    params.access_orlando,
    params.access_miami,
    params.access_boca,
    params.access_jacksonville,
    params.access_boston,
    params.access_tampa,
              ...
              {initializing ? (
                ...
                <>
                  ...
                  >
                    ...
                    >
                      Your status has been changed to ex-student. In case you
                      need any information, please contact:{" "}
                    </Text>
                    {student.registrationNumber &&
                      student.registrationNumber.substring(0, 3) === "ORL" && (
                        <TouchableOpacity
                          ...
                          onPress={() =>
                            Linking.openURL(
                              `mailto:${params.contact_orl}?subject=Ex-student access`
                            )
                          }
                        >
                    ...
                    {student.registrationNumber &&
                      student.registrationNumber.substring(0, 3) === "MIA" && (
                        <TouchableOpacity
                          ...
                          onPress={() =>
                            Linking.openURL(
                              `mailto:${params.contact_mia}?subject=Ex-student access`
                            )
                          }
                        >
                          <Text style={{ fontWeight: "bold" }}>
                    ...
                    {student.registrationNumber &&
                      student.registrationNumber.substring(0, 3) === "BOC" && (
                        <TouchableOpacity
                          ...
                          onPress={() =>
                            Linking.openURL(
                              `mailto:${params.contact_boc}?subject=Ex-student access`
                            )
                          }
                        >
                          <Text style={{ fontWeight: "bold" }}>
                    ...
                    {student.registrationNumber &&
                      student.registrationNumber.substring(0, 3) === "JAX" && (
                        <TouchableOpacity
                          ...
                          onPress={() =>
                            Linking.openURL(
                              `mailto:${params.contact_jax}?subject=Student Dashboard`
                            )
                          }
                        >
                          <Text style={{ fontWeight: "bold" }}>
                    ...
                    {student.registrationNumber &&
                      student.registrationNumber.substring(0, 3) === "BOS" && (
                        <TouchableOpacity
                          ...
                          onPress={() =>
                            Linking.openURL(
                              `mailto:${params.contact_bos}?subject=Student Dashboard`
                            )
                          }
                        >
                          <Text style={{ fontWeight: "bold" }}>
                    ...
                    {student.registrationNumber &&
                      student.registrationNumber.substring(0, 3) === "TAM" && (
                        <TouchableOpacity
                          ...
                          onPress={() =>
                            Linking.openURL(
                              `mailto:${params.contact_tam}?subject=Student Dashboard`
                            )
                          }
                        >
                          <Text style={{ fontWeight: "bold" }}>
                    ...
                    <Text style={{ textAlign: "left", width: "100%" }}>
                      MILA's Intelligence Team
                    </Text>
                  </Container>
                  <TouchableOpacity
                    style={[
                      theme.buttons.secondaryButton,
                      { flexDirection: "column", height: 60 },
                    ]}
                    onPress={() => {
                      navigation.push("AccessChanged");
                    }}
                  >
                    <BtnText style={{ fontSize: 14 }}>
                      I have been transfered to
                    </BtnText>
                    <BtnText style={{ fontSize: 14 }}>
                      another MILA branch
                    </BtnText>
                  ...
                  frequency.findIndex(
                    (freq) => freq.period === format(new Date(), "y-MM")
                  )
                ].percFrequency < params.maxAbsenses ? (
                <Container
                  style={{
                    backgroundColor: "#FFF",
                    width: "90%",
                  ...
                  {student.registrationNumber &&
                    student.registrationNumber.substring(0, 3) === "ORL" && (
                      <TouchableOpacity
                        ...
                        onPress={() =>
                          Linking.openURL(
                            `mailto:${params.contact_orl}?subject=Student Dashboard`
                          )
                        }
                      >
                        <Text style={{ fontWeight: "bold" }}>
                  ...
                  {student.registrationNumber &&
                    student.registrationNumber.substring(0, 3) === "MIA" && (
                      <TouchableOpacity
                        ...
                        onPress={() =>
                          Linking.openURL(
                            `mailto:${params.contact_mia}?subject=Student Dashboard`
                          )
                        }
                      >
                        <Text style={{ fontWeight: "bold" }}>
                  ...
                  {student.registrationNumber &&
                    student.registrationNumber.substring(0, 3) === "BOC" && (
                      <TouchableOpacity
                        ...
                        onPress={() =>
                          Linking.openURL(
                            `mailto:${params.contact_boc}?subject=Student Dashboard`
                          )
                        }
                      >
                        <Text style={{ fontWeight: "bold" }}>
